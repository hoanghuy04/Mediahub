...
public class NotificationTemplateServiceImpl implements NotificationTemplateService {
    ...
    public NotificationTemplateResponse update(String id, UpdateTemplateRequest request) {
        ...
        NotificationTemplate template = notificationTemplateRepository.findById(id).orElseThrow(() -> new AppException((ErrorCode.NOTIFICATION_TEMPLATE_NOT_FOUND)));
    ...
    @Override
    public NotificationTemplateResponse getTemplate(NotificationType type, String locale) {

        log.debug("Fetching template type={} locale={}", type, locale);

        NotificationTemplate template =
                notificationTemplateRepository.findByTypeAndLocaleAndActiveTrue(type, locale).orElseThrow(() ->
                                 new AppException(ErrorCode.NOTIFICATION_TEMPLATE_NOT_FOUND)
                         );
    ...
    @Override
    public String renderTitle(NotificationType type, String locale, Map<String, Object> data) {

        log.debug("Rendering title type={} locale={}", type, locale);

        NotificationTemplate template =
                notificationTemplateRepository.findByTypeAndLocaleAndActiveTrue(type, locale)
                        .orElseThrow();
    ...
    @Override
    public String renderBody(NotificationType type, String locale, Map<String, Object> data) {

        log.debug("Rendering body type={} locale={}", type, locale);
